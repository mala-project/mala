...
class Density(TargetBase):
    ...
    def get_density(self, density_data, convert_to_threedimensional=False,
        ...
        grid_dimensions : list
            ...
            1D -> 3D. If None, FESL will attempt to use the values read with
    ...
    def get_energy_contributions(self, density_data, create_file=True,
        ...
        create_file : bool
            If False, the last fesl.pw.scf.in file will be used as input for
            Quantum Espresso. If True (recommended), FESL will create this
        ...
        if create_file:
            ...
            ase.io.write("fesl.pw.scf.in", atoms_Angstrom, "espresso-in",
        ...
        if Density.te_mutex is False:
            printout("FESL: Starting QuantumEspresso to get density-based"
                     " energy contributions.")
            te.initialize()
            Density.te_mutex = True
            printout("FESL: QuantumEspresso setup done.")
        else:
            printout("FESL: QuantumEspresso is already running. Except for"
        ...
        if number_of_atoms != atoms_Angstrom.get_global_number_of_atoms():
            raise Exception("Number of atoms is inconsistent between FESL "
        ...
        if number_of_gridpoints_fesl != number_of_gridpoints:
            raise Exception("Grid is inconsistent between FESL and"
                            " Quantum Espresso")
