...
def tree_l_inters(l, L_R=0, M_R=0):
    ...
    if rank == 1:
        ...
        next_node_inters = [
            get_intermediates_w(L1L2[0], L1L2[1]) for L1L2 in L1L2_prod
        ]
        ...
        next_node_inters = [
            get_intermediates_w(L1L2L3[0], L1L2L3[1]) for L1L2L3 in L1L2L3_prod
        ]
        ...
        next_node_inters_r = [
            get_intermediates_w(L1L2L3[2], l[remainder])
        ...
        next_node_inters_l = [
            get_intermediates_w(L1L2L3L4[0], L1L2L3L4[1])
