...
data_converter.convert_snapshots(
    ...
    naming_scheme="converted_from_numpy_*.bp4",
...
for snapshot in range(2):
    data_converter.add_snapshot(
        ...
        descriptor_input_path="converted_from_numpy_{}.in.bp4".format(
            snapshot
        ),
        target_input_type="openpmd",
        target_input_path="converted_from_numpy_{}.out.bp4".format(snapshot),
        additional_info_input_type=None,
        additional_info_input_path=None,
        target_units=None,
    )
